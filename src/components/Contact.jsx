      ...
      <div className="contact bg-[linear-gradient(90deg,#b004b0,#38097a);] w-full">
        <div className="wrapper flex justify-center  py-16 gap-52 lg:py-12">
          ...
          <div className="content-box ">
            ...
            <p className="text-xl font-thin py-3 text-white"><i className="me-3 fa-solid fa-envelope"></i>abid.akram01@gmail.com</p>
            <p className="text-xl font-thin py-3 text-white"><i className="me-3 fa-solid fa-phone"></i>+91-9026553313</p>
